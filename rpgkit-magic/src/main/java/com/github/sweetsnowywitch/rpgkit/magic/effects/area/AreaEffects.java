...
public class AreaEffects {
    ...
    public static AreaEffect.JsonFactory FORCEFIELD = ForcefieldEffect::new;
    ...
    public static void register() {
        ...
        Registry.register(MagicRegistries.AREA_EFFECTS, new Identifier(RPGKitMagicMod.MOD_ID, "forcefield"), FORCEFIELD);
