package com.github.foxcpp.rpgkitmc.magic.client.model;

import com.github.foxcpp.rpgkitmc.magic.RPGKitMagicMod;
import com.github.foxcpp.rpgkitmc.magic.entities.SpellChargeEntity;
...
public class SpellChargeModel extends EntityModel<SpellChargeEntity> {
    ...
    public static final EntityModelLayer MAIN = new EntityModelLayer(new Identifier(RPGKitMagicMod.MOD_ID, "spell_charge"), "main");
