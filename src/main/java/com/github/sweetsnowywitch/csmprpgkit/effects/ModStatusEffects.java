...
public class ModStatusEffects {
    ...
    public static void register() {
        ...
        Registry.register(Registry.STATUS_EFFECT, Identifier.of(RPGKitMod.MOD_ID, "sealed"), SEALED);
        Registry.register(Registry.STATUS_EFFECT, Identifier.of(RPGKitMod.MOD_ID, "mana_regen"), MANA_REGEN);
    }
}
