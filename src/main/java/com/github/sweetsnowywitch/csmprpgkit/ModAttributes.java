...
public class ModAttributes {
    public static final EntityAttribute MAX_MANA = make("max_mana", 10, 0, 2000);
    ...
    private static EntityAttribute make(final String name, final double base, final double min, final double max) {
        return new ClampedEntityAttribute("attribute.name.generic." + RPGKitMod.MOD_ID + '.' + name, base, min, max).setTracked(true);
    }
