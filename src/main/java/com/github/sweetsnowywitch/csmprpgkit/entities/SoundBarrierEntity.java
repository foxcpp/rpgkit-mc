...
public class SoundBarrierEntity extends Entity {
    // Populated only on logical server side.
    public ServerSpellCast cast = null;
    private int maxAge = 15*20;
    ...
    public static final TrackedData<Box> AREA = DataTracker.registerData(SoundBarrierEntity.class, RPGKitMod.BOX_TRACKED_HANDLER);
    public static final TrackedData<SpellCast> CAST = DataTracker.registerData(SoundBarrierEntity.class, SpellCast.TRACKED_HANDLER);
